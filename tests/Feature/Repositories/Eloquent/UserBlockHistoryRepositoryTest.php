...
describe('User Block History Repository', function () {
    beforeEach(function () {
        ...
        $this->userBlockHistoryRepository = new UserBlockHistoryRepository();
    });
    ...
    it('should be able to create a history record', function (
        ...
        $blockHistory = $this->userBlockHistoryRepository->addToHistory($data);
    ...
    it('should return count with default parameters', function (int $count) {
        ...
        $lockHistoryCount = $this->userBlockHistoryRepository->historyRecordsCount($user);
