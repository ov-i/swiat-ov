<section class="user-table font-secondary">
  ...
  <article class="bg-white w-full p-4 rounded-md shadow">
    ...
    <!-- User table filter -->
    <section class="user-table-filters w-full flex flex-row space-x-2 lg:space-x-3 py-5 lg:py-7 border-b border-gray-200">
    ...
    <section class="table-content w-full">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          @foreach ($users as $user)
            <tr class="bg-white border-b last:border-none dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" wire:key="{{ $user->id }}">
              <td class="w-4 p-4">
                <div class="flex items-center">
