...
@section('content')
    <section class="w-full mt-40 h-screen">
        <section class="bg-white p-4 rounded-sm shadow border-t-2 border-cyan-600 w-full md:w-11/12 lg:w-9/12 v-large:w-7/12 mx-auto">
            <section>
                <h1 class="text-2xl font-secondary mb-2">{{ __('Mój dashboard') }}</h1>

                <section class="flex flex-col lg:flex-row items-start gap-2 w-full">
                    <ul class="flex-column space-y space-y-4 text-sm w-full lg:w-60 font-medium text-gray-500 dark:text-gray-400 md:me-4 mt-4 mb-4 md:mb-0">
                        <li>
                    ...
                    <div class="p-6 mt-4 bg-gray-50 text-medium self-start justify-start text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
