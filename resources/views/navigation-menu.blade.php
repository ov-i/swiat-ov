            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-mark class="block h-9 w-auto dark:text-white" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('writePost')
                        <x-nav-link href="{{ route('user.posts', ['user', Auth::user()]) }}">
                            {{ __('Posts') }}
                        </x-nav-link>
                    @endcan
                </div>
