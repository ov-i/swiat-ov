...
CREATE TABLE `license_user` (
  ...
  `stopped_at` timestamp NOT NULL DEFAULT '2024-05-30 13:43:35',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `post_histories` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `post_id` bigint unsigned NOT NULL,
  `action` enum('created','scheduled','updated','savedAsDraft','archived','deleted','restored','forceDeleted','unpublished','published','closed') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `posts` (
  ...
  `type` enum('post','event','vip') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'post',
  `status` enum('published','archived','unpublished','scheduled','intrash','closed','draft') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpublished',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2023_06_07_000001_create_pulse_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2023_10_12_113241_create_permission_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2023_10_12_113729_create_roles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2023_10_12_122103_create_model_has_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2023_10_12_122619_create_model_has_roles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2023_10_12_122909_create_role_has_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2023_10_12_132621_create_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2023_10_12_132713_create_tags_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2023_10_12_132852_create_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2023_10_13_112613_create_posts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2023_10_13_113644_create_attachments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2023_10_13_114527_create_post_tag_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2023_10_13_114919_create_lang_post_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2023_10_13_115500_create_user_post_likes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2023_10_13_115621_create_user_post_likes_action_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2023_10_13_132341_create_licenses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2023_10_13_133057_create_license_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2023_10_13_133330_create_license_user_action_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2023_10_24_083344_create_visits_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'2023_10_24_090223_create_fraud_scores_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2023_10_24_163040_create_site_maps_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2023_10_24_165958_add_foreign_key_to_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2023_10_25_130507_add_scheduled_publish_date_column_to_posts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2023_10_26_140807_create_sessions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2023_11_12_103324_create_user_block_histories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2023_11_20_113953_add_lock_reason_column_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2023_11_30_131456_create_user_account_histories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2023_11_30_154753_add_soft_deletes_column_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2023_12_03_164553_create_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2023_12_12_081637_add_unique_key_to_filename_column_in_attachments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2023_12_12_082847_add_public_url_column_to_attachments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2023_12_12_092816_add_unique_key_to_checksum_column_in_attachments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2023_12_17_150259_create_attachment_post_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2023_12_18_114138_add_description_column_to_posts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2023_12_18_135308_create_post_histories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2023_12_18_141301_create_app_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2024_01_18_162040_add_slug_column_to_posts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2024_01_28_115205_create_user_follows_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2024_03_12_114332_add_operator_id_column_in_user_block_histories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2024_03_20_162438_create_user_app_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2024_03_28_104028_add_user_foreign_key_to_attachments_table',1);
